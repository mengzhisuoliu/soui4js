...
class SAnimatorListener : public IAnimatorListener, public IAnimatorUpdateListener, public qjsbind::JsThisOwner
{
public:
	SAnimatorListener() {}
...
void Exp_SAnimatorListener(qjsbind::Module* module) {
	...
	jsCls.AddGetSet("onAnimationUpdate", &SAnimatorListener::m_onAnimationUpdate);

...
import { COLORREF, HICON, HSTREEITEM, LPARAM, UINT, WORD, int, long } from "soui4/Typedef";
...
export class IProgress extends ICtrl{
     ...
     * Describe  获取进度值
     */
    GetRange(pMin:PINT, pMax:PINT)  :void;
    /**
...
export class IPanel extends ICtrl{
     ...
     * @return
     */
    GetScrollRange( bVertical:boolean, lpMinPos:LPINT , lpMaxPos:LPINT ) :boolean;
...
export class IDateTimerPicker extends ICtrl{
     ...
     * @return
     */
    SetTime( wYear:WORD , wMonth:WORD , wDay:WORD , wHour:WORD , wMinute:WORD , wSecond:WORD ) :void;
     ...
     * @return
     */
    GetTime( wYear:LPWORD, wMonth:LPWORD , wDay:LPWORD , wHour:LPWORD, wMinute:LPWORD , wSecond:LPWORD )  :void;
...
export class ITreeCtrl extends IPanel{
     ...
     * @return boolean
     */
    GetItemImage( hItem:HSTREEITEM , nImage:LPINT, nSelectedImage:LPINT)  :boolean;
...
export class IStackView extends ICtrl{
    ...
    SelectView( iView:int,enableAnimate:boolean) :boolean;
